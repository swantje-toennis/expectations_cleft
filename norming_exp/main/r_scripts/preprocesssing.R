...
#Fillers abspeichern
write.table(fillers, file="C:/Arbeit/Expectedness/experiments/pretest/main/results/preprocessed_data/fillers.csv", row.names = FALSE, col.names = TRUE, sep = ";")
...
write.table(excluded_data, file="C:/Arbeit/Expectedness/experiments/pretest/main/results/preprocessed_data/excluded_data.csv", row.names = FALSE, col.names = TRUE, sep = ";")
...
write.table(data, file="C:/Arbeit/Expectedness/experiments/pretest/main/results/preprocessed_data/data.csv", row.names = FALSE, col.names = TRUE, sep = ";")
